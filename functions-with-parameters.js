...
function merge (wordA, wordB){
  return wordA + wordB;
}

const wordMerge = merge ("zoet", "sappig");
console.log(wordMerge);
...
const ageDog = calculateDogYears(6);
console.log(ageDog);
...
const detailedInfo = createDetailString({ firstName: "Jan", lastName: "Janssen", profession: "docent"});
